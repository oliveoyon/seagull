  ...
  <footer class="main-footer">
    <strong><a href="<?=site_url('book_author/guidelines');?>">Guidelines</a></strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong><a href="<?=site_url('book_author/terms_of_services');?>">Terms of Use</a></strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong><a href="<?=site_url('book_author/ethical_statement');?>">Ethics</a></strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong><a href="<?=site_url('book_author/service_policy');?>">Policy</a></strong>
  </footer>
