              ...
              <table id="example1" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
                      <thead>
                        ...
                        <tr>
                          ...
                          <td>
                            <?php if($rev->reviewer_status == 1){?>
                            <a href="<?=site_url('book_author/revtoggle/'.$rev->reviewer_hash_id.'/1');?>" onclick="return confirm('Are you sure?');">Deactivate</a>
                            <?php } else{?>
                            <a href="<?=site_url('book_author/revtoggle/'.$rev->reviewer_hash_id.'/0');?>" onclick="return confirm('Are you sure?');">Activate</a>
                            <?php }?>
                          </td>
                        </tr>
                      <?php } ?>
