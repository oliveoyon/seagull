...
<head>
  ...
  <title>Book Reviewer | Log in</title>
...
<div class="login-box">
  ...
  <div class="login-box-body">
    ...
    <?php echo form_open('login/book_member');?>
      
       <div class="form-group has-feedback">
        <input type="email" name="member_email" class="form-control" placeholder="Reviewer Email" required value="<?=set_value('member_email');?>">
