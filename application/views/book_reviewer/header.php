        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs"><?=$sess=$this->session->userdata('book_reviewer')->reviewer_name;?></span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="<?=site_url('book_reviewer/view_profile');?>" class="btn btn-default btn-flat">Profile</a>
                </div>
                <div class="pull-right">
                  <a href="<?=site_url('book_reviewer/logout');?>" class="btn btn-default btn-flat">Sign out</a>
                </div>
              </li>
            </ul>
          </li>
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        ...
        <div class="pull-left info">
          <p>Anup Kumar</p>
          <a href="#"><i class="fa fa-circle text-success"></i> Book Reviewer</a>
        </div>
      </div>
      <!-- search form -->
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="<?=site_url('book_reviewer/dashboard');?>">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?=site_url('book_reviewer/my_reviewed_books');?>"><i class="fa fa-circle-o"></i> My Reviewed</a></li>
            <li><a href="<?=site_url('book_reviewer/pending_papers');?>"><i class="fa fa-circle-o"></i> Pending Lists</a></li>
            <li><a href="<?=site_url('book_reviewer/published_books');?>"><i class="fa fa-circle-o"></i> View Published Books</a></li>
          </ul>
        </li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?=site_url('book_reviewer/upload_new_file');?>"><i class="fa fa-circle-o"></i> Upload New</a></li>
            <li><a href="<?=site_url('book_reviewer/uploaded_files');?>"><i class="fa fa-circle-o"></i> View Uploaded Files</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
           <?php
              ...
              $mybooks=$this->Mdb->getData('book_assign_reviewer',array('reviewer_id'=>$reviewer_id));
              foreach ($mybooks as $mb) {
            ?>
            <li><a href="<?=site_url('book_reviewer/chat/'.$mb->manuscript_no.'/'.$mb->book_author_req_id);?>"><i class="fa fa-circle-o"></i> <?=$mb->manuscript_no;?></a></li>
            <?php } ?>
          </ul>
        </li>
