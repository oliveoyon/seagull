          ...
          <div class="row">
             ...
             <div class="col-md-6">
              <div class="form-group">
                ...
                <select name="pdt_cat_id" id="" class="form-control">
                  ...
                  <option value="<?=$cat->pdt_cat_id;?>" <?=$data->pdt_cat_id == $cat->pdt_cat_id ? ' selected="selected"' : '';?>><?=$cat->pdt_cat_name;?></option>
                  <?php endforeach;?>
                </select>
              </div>
            </div>
             ...
             <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="pdt_subcat_name" required="" id="inputEmail3" placeholder="Categolry Name" value="<?=$data->pdt_subcat_name;?>">
              </div>
            </div>
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <select name="pdt_subcat_status" id="" class="form-control">
                  <option value="1" <?=$data->pdt_subcat_status == 1 ? ' selected="selected"' : '';?>>Active</option>
                  <option value="0" <?=$data->pdt_subcat_status == 0 ? ' selected="selected"' : '';?>>InActive</option>
                </select>
              </div>
            </div>
