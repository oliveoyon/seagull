...
<section class="content">
  <?php echo form_open('product/add_product_category');?>
          ...
          <div class="row">
             ...
             <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="pdt_cat_name" required="" id="inputEmail3" placeholder="Categolry Name" value="<?=set_value('pdt_cat_name');?>">
              </div>
            </div>
