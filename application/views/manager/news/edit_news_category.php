<section class="content-header">
      <h1>
        news Management
        <small>Edit news Category</small>
      </h1>
      <ol class="breadcrumb">
          ...
          <div class="row">
             ...
             <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="news_cat_name" required="" id="inputEmail3" placeholder="Categolry Name" value="<?=$data->news_cat_name;?>">
              </div>
            </div>
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <select name="news_cat_status" id="" class="form-control">
                  <option value="1" <?=$data->news_cat_status == 1 ? ' selected="selected"' : '';?>>Active</option>
                  <option value="0" <?=$data->news_cat_status == 0 ? ' selected="selected"' : '';?>>InActive</option>
                </select>
              </div>
            </div>
