<section class="content-header">
      <h1>
        Journal Management
        <small>Add Journal Category</small>
      </h1>
      <ol class="breadcrumb">
          ...
          <div class="row">
             ...
             <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="journal_cat_title" required="" id="inputEmail3" placeholder="Categolry Name" value="<?=set_value('journal_cat_name');?>">
              </div>
            </div>
